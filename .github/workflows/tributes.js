...
export default function TributesPage() {
  return (
    <div className="min-h-screen bg-pink-50 p-6">
      ...
      <h1 className="text-4xl font-bold text-pink-700 mb-4 text-center">Tributes</h1>
      <p className="text-center text-pink-900 max-w-xl mx-auto">
        Coming soon: a space to share love stories, memories, and tributes in honor of Tara and all eternal love.
      </p>
    </div>
  );
}